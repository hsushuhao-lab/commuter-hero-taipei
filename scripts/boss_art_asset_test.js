...
const p2 = path.join(root, 'source/assets/boss_flower_phase2_v9_7_6.png');
...
if (!boss.includes('boss_flower_phase1_v9_7_4.png') || !boss.includes('boss_flower_phase2_v9_7_6.png')) throw new Error('runtime references missing');
if (boss.includes("globalCompositeOperation = 'multiply'")) throw new Error('Boss multiply workaround remains');
console.log('PASS: v9.7.6 text-free P2 runtime PNG path and source-over integration validated.');
